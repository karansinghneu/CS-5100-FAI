...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        currentStateValue = self.qvalues[(state, action)]
        calculation = reward + (self.discount * nextStateValue) - currentStateValue

        self.qvalues[(state, action)] = currentStateValue + (self.alpha * calculation)
