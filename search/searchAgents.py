...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        #If there are 4 elements in the corners array we will say that all corners are visited
...
def foodHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    # In a trivial case where there is no food, we can say that we don't have a problem 
    #to solve.
    if len(food) == 0:
        return 0
        
    
    # Using the given maze-distance function for the heuristic 
    # It takes a little more time than usual but is efficient
    # Heursitic will also return 0 but and will never return a 
    #negative (since distances can't be negative)
